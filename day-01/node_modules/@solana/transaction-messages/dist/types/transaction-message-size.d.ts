 ...
 */
export type ExcludeTransactionMessageWithinSizeLimit<TTransactionMessage extends TransactionMessage> = Omit<TTransactionMessage, '__transactionSize:@solana/kit'>;
