 ...
 * ```
 */
export declare function addSignersToTransactionMessage<TTransactionMessage extends Readonly<{
    instructions: readonly Instruction[];
}>>(signers: TransactionSigner[], transactionMessage: TTransactionMessage): TransactionMessageWithSigners & TTransactionMessage;
