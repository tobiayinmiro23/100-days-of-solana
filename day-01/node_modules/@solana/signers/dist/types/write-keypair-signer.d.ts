import { WriteKeyPairConfig } from '@solana/keys';
 ...
 * a 64-byte buffer.
 */
export declare function writeKeyPairSigner(signer: KeyPairSigner, path: string, config?: WriteKeyPairConfig): Promise<void>;
//# sourceMappingURL=write-keypair-signer.d.ts.map