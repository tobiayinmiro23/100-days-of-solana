 ...
 */
export declare function getTupleEncoder<const TItems extends readonly FixedSizeEncoder<any>[]>(items: TItems, config?: TupleCodecConfig): FixedSizeEncoder<GetEncoderTypeFromItems<TItems>>;
export declare function getTupleEncoder<const TItems extends readonly Encoder<any>[]>(items: TItems, config?: TupleCodecConfig): VariableSizeEncoder<GetEncoderTypeFromItems<TItems>>;
/**
 ...
 */
export declare function getTupleCodec<const TItems extends readonly FixedSizeCodec<any>[]>(items: TItems, config?: TupleCodecConfig): FixedSizeCodec<GetEncoderTypeFromItems<TItems>, GetDecoderTypeFromItems<TItems> & GetEncoderTypeFromItems<TItems>>;
export declare function getTupleCodec<const TItems extends readonly Codec<any>[]>(items: TItems, config?: TupleCodecConfig): VariableSizeCodec<GetEncoderTypeFromItems<TItems>, GetDecoderTypeFromItems<TItems> & GetEncoderTypeFromItems<TItems>>;
export {};
