 ...
 */
export declare function getPredicateEncoder<TFrom, TSize extends number>(predicate: (value: TFrom) => boolean, ifTrue: FixedSizeEncoder<TFrom, TSize>, ifFalse: FixedSizeEncoder<TFrom, TSize>): FixedSizeEncoder<TFrom, TSize>;
export declare function getPredicateEncoder<TFrom>(predicate: (value: TFrom) => boolean, ifTrue: FixedSizeEncoder<TFrom>, ifFalse: FixedSizeEncoder<TFrom>): FixedSizeEncoder<TFrom>;
export declare function getPredicateEncoder<TFrom>(predicate: (value: TFrom) => boolean, ifTrue: VariableSizeEncoder<TFrom>, ifFalse: VariableSizeEncoder<TFrom>): VariableSizeEncoder<TFrom>;
export declare function getPredicateEncoder<TFrom>(predicate: (value: TFrom) => boolean, ifTrue: Encoder<TFrom>, ifFalse: Encoder<TFrom>): Encoder<TFrom>;
/**
 ...
 * @see {@link getPredicateCodec}
 */
export declare function getPredicateDecoder<TTo, TSize extends number>(predicate: (value: ReadonlyUint8Array) => boolean, ifTrue: FixedSizeDecoder<TTo, TSize>, ifFalse: FixedSizeDecoder<TTo, TSize>): FixedSizeDecoder<TTo, TSize>;
export declare function getPredicateDecoder<TTo>(predicate: (value: ReadonlyUint8Array) => boolean, ifTrue: FixedSizeDecoder<TTo>, ifFalse: FixedSizeDecoder<TTo>): FixedSizeDecoder<TTo>;
export declare function getPredicateDecoder<TTo>(predicate: (value: ReadonlyUint8Array) => boolean, ifTrue: VariableSizeDecoder<TTo>, ifFalse: VariableSizeDecoder<TTo>): VariableSizeDecoder<TTo>;
export declare function getPredicateDecoder<TTo>(predicate: (value: ReadonlyUint8Array) => boolean, ifTrue: Decoder<TTo>, ifFalse: Decoder<TTo>): Decoder<TTo>;
/**
 ...
 */
export declare function getPredicateCodec<TFrom, TTo extends TFrom, TSize extends number>(encodePredicate: (value: TFrom) => boolean, decodePredicate: (value: ReadonlyUint8Array) => boolean, ifTrue: FixedSizeCodec<TFrom, TTo, TSize>, ifFalse: FixedSizeCodec<TFrom, TTo, TSize>): FixedSizeCodec<TFrom, TTo, TSize>;
export declare function getPredicateCodec<TFrom, TTo extends TFrom>(encodePredicate: (value: TFrom) => boolean, decodePredicate: (value: ReadonlyUint8Array) => boolean, ifTrue: FixedSizeCodec<TFrom, TTo>, ifFalse: FixedSizeCodec<TFrom, TTo>): FixedSizeCodec<TFrom, TTo>;
export declare function getPredicateCodec<TFrom, TTo extends TFrom>(encodePredicate: (value: TFrom) => boolean, decodePredicate: (value: ReadonlyUint8Array) => boolean, ifTrue: VariableSizeCodec<TFrom, TTo>, ifFalse: VariableSizeCodec<TFrom, TTo>): VariableSizeCodec<TFrom, TTo>;
export declare function getPredicateCodec<TFrom, TTo extends TFrom>(encodePredicate: (value: TFrom) => boolean, decodePredicate: (value: ReadonlyUint8Array) => boolean, ifTrue: Codec<TFrom, TTo>, ifFalse: Codec<TFrom, TTo>): Codec<TFrom, TTo>;
